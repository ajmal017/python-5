...
app.layout = html.Div([
    ...
    html.Div([
        dcc.Input(id='input_state', type='text', value='01/22/20',
                  max='04/06/20', min='01/22/20', step=1, required=True),
...
def update_output(num_clicks, val_selected):
    if val_selected is None:
        ...
        df = px.data.gapminder().query("day=={}".format(val_selected))
        # print(df[:3])
        ...
        fig = px.choropleth(df, locations="alpha_3",
                            ...
                            title='Deaths of Corona per day',
